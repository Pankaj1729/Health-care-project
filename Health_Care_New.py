...
class QuestionDigonosis(Frame):
    ...
    def createWidget(self):
        ...
        self.btnClear = Button(self.label, text="Clear", width=12, bg="bisque", command=self.btnClear_Click,
                               font='bold')
        self.btnClear.grid(row=27, column=0)
        self.btnStart = Button(self.label, text="Start", width=12, bg="bisque", command=self.btnStart_Click,
                               font='bold')
...
class Login(Frame):
    ...
    def createWidget(self):
        ...
        self.btnLogin = Button(self, text="Login", width=10, height=1, command=self.btnLogin_Click, font='bold',
                               bg='white')
...
class SignUp(Frame):
    ...
    def createWidget(self):
        ...
        self.btnRegister = Button(self, text="Register", width=10, height=1, font="bold", command=self.register_user,
                                  bg='white')
